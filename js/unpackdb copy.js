...
const record = {};
const postsTemp = [];
const postTempObject = {};
const commentTempList = []
const commentTempDict = {};
const replyTemp = [];
...
// loop accross each post

// console.log(replies)
posts.forEach((post, index) => {
  // post  is object   { }
  if (index == 0) {
    let filteredPostComments = postComments.filter((postComment) => 1 == postComment.postId );
      // console.log(filteredPostComments);
    // filteredPostComments is array of objects  [ {}, {} ...]
    filteredPostComments.forEach((comment, index) => {
      commentTempList.push(comment);
      console.log(commentTempList)
      commentTempDict.comment = commentTempList;

      // // comment is object { }

      //   let filteredReplies= replies.filter((reply) => reply.parentId == comment.commenterId);
      //   // console.log(filteredReplies);
      //   // FilteredReplies  is array of objects  [ {}, {} ...]
      //   // every time you find a reply push it to reply array

      //   replyTemp.push(filteredReplies);
      //   // console.log(replyTemp);
      // //  replyTemp is array of object [{}, {} ...]



    // console.log(commentTempDict);
